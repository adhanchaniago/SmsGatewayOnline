  <?php echo form_open("index.php/rombongan/tambah_data"); ?>
        ...
        <div class="form-label-group">
          <input type="text" name="perwakilan" class="form-control" placeholder="Perwakilan rombongan" required="" autofocus="">
        ...
        <div class="form-label-group">
          <input type="text" name="anggota" class="form-control" placeholder="Jumlah anggota" required="" autofocus="">
          <label for="jmlRombongan"></label>
        </div>
